...
def download_data(scraper):
    # go to livestream analytics page
    scraper.navigate_to_url(f"https://seller-id.tiktok.com/compass/live-analysis/live-details")
    time.sleep(15)
...
def main(scraper, store_name):
    ...
    try:
        ...
        logger.error(f"Error downloading live analysis data from {store_name}: {e}")
        pass
