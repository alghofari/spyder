...
def request_file(start_time, end_time, official_store_name):
    ...
    url = f"https://seller.shopee.co.id/api/v1/return/export?SPC_CDS={spc_cds[0]['value']}&SPC_CDS_VER=2&type=refund&start_date={start_time}&end_date={end_time}&language=id"
    ...
    headers = {
            ...
            'cookie': cookie,
            'referer': 'https://seller.shopee.co.id/portal/sale/returnlist',
            'sec-fe-ver': '21.25995',
...
def download_file_to_gcs(start_time, end_time, file_id, official_store_name, storage_client):
    ...
    headers = {
            ...
            'accept-language': 'en-US,en;q=0.9',
            'cookie': cookie,
            'referer': f'https://seller.shopee.co.id/portal/sale/returnlist',
    ...
    # Write excel to gcs
    blob = client.blob(f'assets/excel/shopee/return_order/{official_store_name}/{date.today()}/Shopee_Return_Order_{start_time}_{end_time}.xlsx')
