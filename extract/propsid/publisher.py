...
def extract(driver, start_date, end_date, schema_json):
    url = f'https://dash.props.id/ads/ajax/report/publisher/?partner=&domain=&date={start_date}+-+{end_date}'
    driver.get(url)
...
def main(driver: webdriver):
    ...
    schema_path = base_path + "/schema/publisher.json"
    ...
    try:
        ...
        load(
            dataframe=df,
            table_id="sirclo-prod.bronze_ads_orami.props_publisher_report",
            auto_detect=False,
